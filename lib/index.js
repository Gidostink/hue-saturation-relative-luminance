 ...
 *
 */
export function hueSaturationRelativeLuminance(inputHue, inputSaturation, inputRelativeLuminance) {
 ...
 *
 */
export function getRelativeLuminance(inputSRGB) {
 ...
 *
 */
export function HSLtoSRGB(inputHue, inputSaturation, inputLightness) {
 ...
 *
 */
function clamp(inputNumber, min, max) {
